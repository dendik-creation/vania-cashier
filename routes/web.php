...
Route::prefix("admin")
    ...
    ->group(function () {
        ...
        Route::prefix("product-rejects")->group(function () {
            Route::get("/", [
                AdminProductRejectController::class,
                "index",
            ])->name("admin.product-rejects.index");
            Route::get("/find-variant", [
                AdminProductRejectController::class,
                "getProductVariantsOptions",
            ])->name("admin.product-rejects.find-variant");
            Route::post("/", [
                AdminProductRejectController::class,
                "store",
            ])->name("admin.product-rejects.store");
            Route::put("/{id}", [
                AdminProductRejectController::class,
                "update",
            ])->name("admin.product-rejects.update");
            Route::delete("/{id}", [
                AdminProductRejectController::class,
                "destroy",
            ])->name("admin.product-rejects.destroy");
        });
...
Route::prefix("cashier")
    ...
    ->group(function () {
        ...
        Route::prefix("products")->group(function () {
            // Label
            Route::get("/label", [
                CashierProductController::class,
                "labelView",
            ])->name("cashier.products.labelView");

            Route::get("/", [CashierProductController::class, "index"])->name(
                "cashier.products.index",
            );
            Route::get("/create", [
                CashierProductController::class,
                "create",
            ])->name("cashier.products.create");
            Route::post("/", [CashierProductController::class, "store"])->name(
                "cashier.products.store",
            );
            Route::post("/import", [
                CashierProductController::class,
                "import",
            ])->name("cashier.products.import");
            Route::get("/{id}", [
                CashierProductController::class,
                "show",
            ])->name("cashier.products.show");
            Route::get("/{id}/edit", [
                CashierProductController::class,
                "edit",
            ])->name("cashier.products.edit");
            Route::put("/{id}", [
                CashierProductController::class,
                "update",
            ])->name("cashier.products.update");
            Route::delete("/{id}", [
                CashierProductController::class,
                "destroy",
            ])->name("cashier.products.destroy");
        });
        ...
        Route::prefix("transactions")->group(function () {
            Route::get("/find/customer", [
                ...
                "findCustomer",
            ])->name("cashier.transactions.findCustomer");
            Route::get("/find/sku", [
                CashierTransactionController::class,
                "findSku",
            ])->name("cashier.transactions.findSku");
            Route::get("/records", [
                CashierTransactionController::class,
                "index",
            ...
            Route::get("/create", [
                CashierTransactionController::class,
                "create",
            ])->name("cashier.transactions.create");
            Route::get("/print/{id}", [
                CashierTransactionController::class,
                "findTrxForPrint",
            ])->name("cashier.transactions.findTrxForPrint");
            Route::post("/", [
                CashierTransactionController::class,
                "store",
        ...
        // Sales Reports Routes
        Route::prefix("reports")->group(function () {
            Route::get("/", [CashierReportController::class, "index"])->name(
                "cashier.reports.index",
            );
            Route::get("/export", [
                CashierReportController::class,
                "export",
            ])->name("cashier.reports.export");
        });
    });
