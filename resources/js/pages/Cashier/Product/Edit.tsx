        ...
        useForm({
            ...
            variants: (product.variants || []).map((v: VariantFormData) => ({
                ...
                attributes: {
                    ...
                    size: v.attributes?.size ? String(v.attributes.size) : "",
                },
                price_criteria: {
                    basic: v.price_criteria?.basic || "",
                    reseller: v.price_criteria?.reseller || "",
                    order_qty_3: v.price_criteria?.order_qty_3 || "",
                    order_qty_6: v.price_criteria?.order_qty_6 || "",
                },
                stock: v.stock,
            })) as VariantFormData[],
        });
...
export default CashierProductEdit;
