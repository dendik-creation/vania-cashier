...
const CashierProductIndex = ({
    ...
    const handleImport = (e: FormEvent) => {
        ...
        postImport(`/cashier/products/import`, {
            headers: {
    ...
    const handleDelete = (productId: number) => {
        router.delete("/cashier/products/" + productId, {
            preserveScroll: true,
            replace: true,
        });
    };
...
export default CashierProductIndex;
